...
const rangedAttackEvent=(a,b) => {
  ...
  addMessage(message)
  message='    - '
  const attackStrength = a.status.rea+a.status[a.weapon.subtype]/2 +  d20(a)
  const defenceStrength = distance(a,b)*a.weapon.rangePen+b.armor[a.weapon.damageType]/a.weapon.penetration+b.status.rea+d20(b)
