const openStatsMenu = (target)=>{
  ...
  if(screenwidth<680){
    ...
    if(target.status.spells.length){
      spellsText+='<div style="top:300;position:absolute;left:800;margin-bottom:10;width:350">Spells: '
    ...
    skillsText='<div style="position:absolute;left:400;top:0">'+displaySkills(target,0,true)+'</div>'
    let effectsText=''
    ...
    '<div style="width:'+(screenwidth-470)+'">'+
    '<div style="width:310">'+
    '<div style="color:#111144">lvl '+target.level+(target.controlled?' <span style="margin-left:50">xp: '+target.xp+'</span>':'')+'</div>'+
    '<div>'+statsText+'</div>'+
    '<div style="font-size:28">Gold: '+target.gold+'</div>'+
    '<div style="font-size:26">'+combatText+'</div>'+
    '</div>'+
    '<div style="margin-top:43">'+itemsText+'</div>'+
    skillsText+
    spellsText+
    '<div style="position:absolute;left:1050;top:280;width:200;font-size:28">'+effectsText+'</div>'+
